...
VBP_2020$MUNICIPIO <- str_replace(VBP_2020$MUNICIPIO, "ITAPEJARA D'OESTE", "ITAPEJARA DOESTE")
VBP_2020$MUNICIPIO <- str_replace(VBP_2020$MUNICIPIO, "BELA VISTA DA CAROBA", "BELA VISTA DO CAROBA")
VBP_2020$MUNICIPIO <- str_replace(VBP_2020$MUNICIPIO, "PÉROLA D'OESTE", "PÉROLA DOESTE")
VBP_2020$MUNICIPIO <- str_replace(VBP_2020$MUNICIPIO, "SÃO JORGE D'OESTE", "SÃO JORGE DOESTE")
VBP_2020$MUNICIPIO <- str_replace(VBP_2020$MUNICIPIO, "SANTA TEREZINHA DO ITAIPU", "SANTA TEREZINHA DE ITAIPU")
VBP_2020$MUNICIPIO <- str_replace(VBP_2020$MUNICIPIO, "RANCHO ALEGRE D'OESTE", "RANCHO ALEGRE DOESTE")
VBP_2020$MUNICIPIO <- str_replace(VBP_2020$MUNICIPIO, "SAUDADES DO IGUACU", "SAUDADE DO IGUACU")
VBP_2020$MUNICIPIO <- str_replace(VBP_2020$MUNICIPIO, "SANTA CRUZ DE MONTE CASTELO", "SANTA CRUZ MONTE CASTELO")
...
VBP_2021$MUNICIPIO <- str_replace(VBP_2021$MUNICIPIO, "ITAPEJARA D'OESTE", "ITAPEJARA DOESTE")
VBP_2021$MUNICIPIO <- str_replace(VBP_2021$MUNICIPIO, "BELA VISTA DA CAROBA", "BELA VISTA DO CAROBA")
VBP_2021$MUNICIPIO <- str_replace(VBP_2021$MUNICIPIO, "PÉROLA D'OESTE", "PÉROLA DOESTE")
VBP_2021$MUNICIPIO <- str_replace(VBP_2021$MUNICIPIO, "SÃO JORGE D'OESTE", "SÃO JORGE DOESTE")
VBP_2021$MUNICIPIO <- str_replace(VBP_2021$MUNICIPIO, "SANTA TEREZINHA DO ITAIPU", "SANTA TEREZINHA DE ITAIPU")
VBP_2021$MUNICIPIO <- str_replace(VBP_2021$MUNICIPIO, "RANCHO ALEGRE D'OESTE", "RANCHO ALEGRE DOESTE")
VBP_2021$MUNICIPIO <- str_replace(VBP_2021$MUNICIPIO, "SAUDADES DO IGUACU", "SAUDADE DO IGUACU")
VBP_2021$MUNICIPIO <- str_replace(VBP_2021$MUNICIPIO, "SANTA CRUZ DE MONTE CASTELO", "SANTA CRUZ MONTE CASTELO")
...
VBP_2022$MUNICIPIO <- str_replace(VBP_2022$MUNICIPIO, "ITAPEJARA D'OESTE", "ITAPEJARA DOESTE")
VBP_2022$MUNICIPIO <- str_replace(VBP_2022$MUNICIPIO, "BELA VISTA DA CAROBA", "BELA VISTA DO CAROBA")
VBP_2022$MUNICIPIO <- str_replace(VBP_2022$MUNICIPIO, "PÉROLA D'OESTE", "PÉROLA DOESTE")
VBP_2022$MUNICIPIO <- str_replace(VBP_2022$MUNICIPIO, "SÃO JORGE D'OESTE", "SÃO JORGE DOESTE")
VBP_2022$MUNICIPIO <- str_replace(VBP_2022$MUNICIPIO, "SANTA TEREZINHA DO ITAIPU", "SANTA TEREZINHA DE ITAIPU")
VBP_2022$MUNICIPIO <- str_replace(VBP_2022$MUNICIPIO, "RANCHO ALEGRE D'OESTE", "RANCHO ALEGRE DOESTE")
VBP_2022$MUNICIPIO <- str_replace(VBP_2022$MUNICIPIO, "SAUDADES DO IGUACU", "SAUDADE DO IGUACU")
VBP_2022$MUNICIPIO <- str_replace(VBP_2022$MUNICIPIO, "SANTA CRUZ DE MONTE CASTELO", "SANTA CRUZ MONTE CASTELO")
...
VBP_2023$MUNICIPIO <- str_replace(VBP_2023$MUNICIPIO, "ITAPEJARA D'OESTE", "ITAPEJARA DOESTE")
VBP_2023$MUNICIPIO <- str_replace(VBP_2023$MUNICIPIO, "BELA VISTA DA CAROBA", "BELA VISTA DO CAROBA")
VBP_2023$MUNICIPIO <- str_replace(VBP_2023$MUNICIPIO, "PÉROLA D'OESTE", "PÉROLA DOESTE")
VBP_2023$MUNICIPIO <- str_replace(VBP_2023$MUNICIPIO, "SÃO JORGE D'OESTE", "SÃO JORGE DOESTE")
VBP_2023$MUNICIPIO <- str_replace(VBP_2023$MUNICIPIO, "SANTA TEREZINHA DO ITAIPU", "SANTA TEREZINHA DE ITAIPU")
VBP_2023$MUNICIPIO <- str_replace(VBP_2023$MUNICIPIO, "RANCHO ALEGRE D'OESTE", "RANCHO ALEGRE DOESTE")
VBP_2023$MUNICIPIO <- str_replace(VBP_2023$MUNICIPIO, "SAUDADES DO IGUACU", "SAUDADE DO IGUACU")
VBP_2023$MUNICIPIO <- str_replace(VBP_2023$MUNICIPIO, "SANTA CRUZ DE MONTE CASTELO", "SANTA CRUZ MONTE CASTELO")
...
PR_DERAL_2017_SIMPLIFICADO$TON_AGRO_2017 <- as.numeric(gsub(",", ".", PR_DERAL_2017_SIMPLIFICADO$TON_AGRO_2017))
PR_DERAL_2017_SIMPLIFICADO$AGRO_HA <- PR_DERAL_2017_SIMPLIFICADO$TON_AGRO_2017/PR_DERAL_2017_SIMPLIFICADO$AREA_HA


PR_DERAL_2018_SIMPLIFICADO$TON_AGRO_2018 <- as.numeric(gsub(",", ".", PR_DERAL_2018_SIMPLIFICADO$TON_AGRO_2018))
PR_DERAL_2018_SIMPLIFICADO$AGRO_HA <- PR_DERAL_2018_SIMPLIFICADO$TON_AGRO_2018/PR_DERAL_2018_SIMPLIFICADO$AREA_HA


PR_DERAL_2019_SIMPLIFICADO$TON_AGRO_2019 <- as.numeric(gsub(",", ".", PR_DERAL_2019_SIMPLIFICADO$TON_AGRO_2019))
PR_DERAL_2019_SIMPLIFICADO$AGRO_HA <- PR_DERAL_2019_SIMPLIFICADO$TON_AGRO_2019/PR_DERAL_2019_SIMPLIFICADO$AREA_HA


PR_DERAL_2020_SIMPLIFICADO$TON_AGRO_2020 <- as.numeric(gsub(",", ".", PR_DERAL_2020_SIMPLIFICADO$TON_AGRO_2020))
PR_DERAL_2020_SIMPLIFICADO$AGRO_HA <- PR_DERAL_2020_SIMPLIFICADO$TON_AGRO_2020/PR_DERAL_2020_SIMPLIFICADO$AREA_HA


PR_DERAL_2021_SIMPLIFICADO$TON_AGRO_2021 <- as.numeric(gsub(",", ".", PR_DERAL_2021_SIMPLIFICADO$TON_AGRO_2021))
PR_DERAL_2021_SIMPLIFICADO$AGRO_HA <- PR_DERAL_2021_SIMPLIFICADO$TON_AGRO_2021/PR_DERAL_2021_SIMPLIFICADO$AREA_HA
...
PR_DERAL_2022_SIMPLIFICADO$TON_AGRO_2022 <- as.numeric(gsub(",", ".", PR_DERAL_2022_SIMPLIFICADO$TON_AGRO_2022))
PR_DERAL_2022_SIMPLIFICADO$AGRO_HA <- PR_DERAL_2022_SIMPLIFICADO$TON_AGRO_2022/PR_DERAL_2022_SIMPLIFICADO$AREA_HA


PR_DERAL_2023_SIMPLIFICADO$TON_AGRO_2023 <- as.numeric(gsub(",", ".", PR_DERAL_2023_SIMPLIFICADO$TON_AGRO_2023))
PR_DERAL_2023_SIMPLIFICADO$AGRO_HA <- PR_DERAL_2023_SIMPLIFICADO$TON_AGRO_2023/PR_DERAL_2023_SIMPLIFICADO$AREA_HA
